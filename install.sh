#!/usr/bin/env sh
# Universal installer for rmf-package. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/rmf-package.git"
echo "Installing rmf-package ..."
...
echo "Done. Run: rmf-package --help"
