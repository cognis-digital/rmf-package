"""Native cognis-connect emit for rmf-package — forward findings to any platform.

Maps rmf-package's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    rmf-package ... --format json | rmf-package-emit --to stix
    rmf-package-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
